  ...
  return (
    <div className="avatar">
      ...
      >
        ...
        <g id="Avataaar" stroke="none" strokeWidth="1" fill="none">
          <g
              ...
              >
                <g id="Body" transform="translate(32.000000, 36.000000)">
                  <mask id="react-mask-6" fill="white">
                    <use xlinkHref="#react-path-3" />
                  </mask>
                  <use fill="#D0C6AC" xlinkHref="#react-path-3" />
                  <g
                    id="Skin/👶🏽-03-Brown"
                ...
                >
                  ...
                  <mask id="react-mask-718" fill="white">
                    <use xlinkHref="#react-path-717" />
                  </mask>
                  <use
                    id="Overall"
                    fill="#B7C1DB"
                    fillRule="evenodd"
                    xlinkHref="#react-path-717"
                  />
                  <g
                    id="Color/Palette/Gray-01"
                    mask="url(#react-mask-718)"
                    fillRule="evenodd"
                    fill="#F18D26"
                  >
                ...
                <g id="Top" strokeWidth="1" fillRule="evenodd">
                  ...
                  <mask id="react-mask-605" fill="white">
                    <use xlinkHref="#react-path-607" />
                  </mask>
                  <g id="Mask" />
                  <g
                    id="Top/Short-Hair/Short-Waved"
                    mask="url(#react-mask-605)"
                  >
                    <g transform="translate(-1.000000, 0.000000)">
                      ...
                      >
                        ...
                        <mask id="react-mask-677" fill="white">
                          <use xlinkHref="#react-path-678" />
                        </mask>
                        <use
                          id="Glorious-Beard"
                          fill="#5E7AA9"
                          fillRule="evenodd"
                          xlinkHref="#react-path-678"
                        />
                        <g
                          id="Color/Hair/Brown"
                          mask="url(#react-mask-677)"
                          fill="#2C1B18"
                        >
                          <g
                      ...
                      <mask id="react-mask-604" fill="white">
                        <use xlinkHref="#react-path-606" />
                      </mask>
                      <use
                        id="Short-Hair"
                        stroke="none"
                        fill="#28354B"
                        fillRule="evenodd"
                        xlinkHref="#react-path-606"
                      />
                      <g
                        id="Skin/👶🏽-03-Brown"
                        mask="url(#react-mask-604)"
                        fill="#2C1B18"
                      >
                        <g
